...
>
	...
	<defs>
		...
		>
			...
			<feBlend mode="normal" in="SourceGraphic" in2="effect4_dropShadow_64_10" result="shape" />
		</filter>
		<filter
			id="filter1_dd_64_10"
			x="109.5"
		...
		>
			...
			<feBlend mode="normal" in2="effect1_dropShadow_64_10" result="effect2_dropShadow_64_10" />
			<feBlend mode="normal" in="SourceGraphic" in2="effect2_dropShadow_64_10" result="shape" />
		</filter>
		<filter
			id="filter2_dd_64_10"
			x="190.058"
