...
<button class="absolute top-0 w-full h-full flex rounded-b-lg bg-black/30" on:click type="button">
	{#if icon === 'plus'}
	...
	{:else if icon === 'edit'}
		<svg
			class="absolute h-7 w-7 bottom-1 right-1 fill-none stroke-neutral-200/70"
			viewBox="0 0 24 24"
		>
			<path
				stroke-linecap="round"
