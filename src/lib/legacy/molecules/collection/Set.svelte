<script lang="ts">
	...
	import { filterByRarity } from '$lib/legacy/collectibles';
	import { newItem } from '$lib/stores';
	import type { Collectible } from '$lib/types';

	import SetIndicator from '$lib/legacy/atoms/collection/SetIndicator.svelte';
	import Card from '$lib/legacy/atoms/collection/Card.svelte';
